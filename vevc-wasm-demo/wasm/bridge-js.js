    ...
    return {
        ...
        createExports: (instance) => {
            ...
            const exports = {
                ...
                encodeFrame: function bjs_encodeFrame(id, data, onDone) {
                    const [dataKind, dataPayload1, dataPayload2] = __bjs_jsValueLower(data);
                    instance.exports.bjs_encodeFrame(id, dataKind, dataPayload1, dataPayload2, swift.memory.retain(onDone));
                },
                ...
                decodeChunk: function bjs_decodeChunk(id, data, onDone) {
                    const [dataKind, dataPayload1, dataPayload2] = __bjs_jsValueLower(data);
                    instance.exports.bjs_decodeChunk(id, dataKind, dataPayload1, dataPayload2, swift.memory.retain(onDone));
                },
