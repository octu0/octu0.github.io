...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        createExports: (instance) => {
            ...
            const exports = {
                createEncoder: function bjs_createEncoder(width, height, maxbitrate, framerate, onChunk) {
                    instance.exports.bjs_createEncoder(width, height, maxbitrate, framerate, swift.memory.retain(onChunk));
                ...
                createDecoder: function bjs_createDecoder(onFrame) {
                    instance.exports.bjs_createDecoder(swift.memory.retain(onFrame));
                    const jsValuePayload2 = f64Stack.pop();
                    const jsValuePayload1 = i32Stack.pop();
                    const jsValueKind = i32Stack.pop();
                    const jsValue = __bjs_jsValueLift(jsValueKind, jsValuePayload1, jsValuePayload2);
